...
describe('NotamsService', () => {
  ...
  it('should decode notam', () => {
    ...
    const decodedNotam = {
      ...
      msg: 'TRIGGER NOTAM - PERMANENT AIRAC AIP AMENDMENT NUMBER 241 EFFECTIVE FROM 29 DEC 2022:     LZTT AD 2.3, AD 2-LZTT-2-1, AD 2-LZTT-2-3 - SELF BRIEFING     TERMINALS CANCELLED     LZTT AD 2.11 - PROVISION OF MET INFORMATION CHANGED.',
    };
